...
def pyplot_euler(output_file_name, output_plot_name, input_file_name):
    ...
    plt.title(f"Yaw, Pitch, Roll of {input_file_name}")
    plt.legend()
    plt.grid(True)
...
def pyplot_quaternions(output_file_name, output_plot_name, input_file_name):
    df = pd.read_csv(output_file_name)
    ...
    plt.title(f"Quaternion values of {input_file_name}")
    plt.legend()
    plt.grid(True)
    # plt.savefig(output_plot_name)
    plt.show()
...
def pyplot_state_grid(output_file_name, output_plot_name, input_file_name):
    df = pd.read_csv(output_file_name)
